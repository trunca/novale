...
def InitUsageConfig():
    ...
    config.usage.leave_movieplayer_onExit = ConfigSelection(default='popup', choices=[('no', _('No')), ('popup', _('With popup')), ('without popup', _('Without popup'))])
    ...
    config.usage.on_long_powerpress = ConfigSelection(default='show_menu', choices=[('show_menu', _('Show shutdown menu')), ('shutdown', _('Immediate shutdown')), ('standby', _('Standby'))])
    config.usage.on_short_powerpress = ConfigSelection(default='standby', choices=[('show_menu', _('Show shutdown menu')), ('shutdown', _('Immediate shutdown')), ('standby', _('Standby'))])
    ...
    for i in range(-900000, 1845000, 45000):
        if i == 0:
            ...
            subtitle_delay_choicelist.append(('%d' % i, '%2.1f sec' % (i / 90000.0)))
