...
class InfoBarChannelSelection():
    ...
    def __init__(self):
        ...
        self['ChannelSelectActions'] = HelpableActionMap(self, 'InfobarChannelSelection', {'keyUp': (self.keyUpCheck, self.getKeyUpHelptext),
         ...
         'updatepluginmenu': (self.updatepluginmenu, _('Show the plugin updatepluginmenu..')),
         'showplayer': (self.showplayer, _('Show player reproductor..')),
...
class InfoBarSfButton():

    def __init__(self):
        self['SfButtonActions'] = HelpableActionMap(self, 'InfobarSfButtonActions', {'activateSfButton': (self.activateSfButton, _('Sf button...')),'activatePluginButton': (self.activatePluginButton, _('Plugin button...'))})

    def activateSfButton(self):
        if self.secondInfoBarScreen and self.secondInfoBarScreen.shown:
            self.secondInfoBarScreen.hide()
            self.secondInfoBarWasShown = False
        from Screens.SFPanel import mainSFPanel
        self.session.open(mainSFPanel)

    def activatePluginButton(self):
        if self.secondInfoBarScreen and self.secondInfoBarScreen.shown:
            self.secondInfoBarScreen.hide()
            self.secondInfoBarWasShown = False
...
class InfoBarHDMI():
    ...
    def __init__(self):
        self['HDMIActions'] = HelpableActionMap(self, 'InfobarHDMIActions', {'HDMIin': (self.HDMIIn, _('Switch to HDMI in mode'))}, prio=2)
